...
namespace DigitalRuby.LightningBolt
{
    ...
    public class LightningBoltScript : MonoBehaviour
    {
        ...
        private int checker;
        private Vector3 pausestart;
        private Vector3 pauseend;
        ...
        private void Start()
        {
            ...
            checker = 1;
            pausestart = new Vector3(0.0f, 0.0f, 0.0f);
            pauseend = new Vector3(0.0f, 0.0f, 0.0f);
        ...
        public void Triggerpause()
        {
            ...
            startIndex = 0;
            GenerateLightningBolt(pausestart, pauseend, Generations, Generations, 0.0f);
            UpdateLineRenderer();
        }
